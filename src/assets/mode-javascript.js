        ...
        "start": [
            {
                ...
                regex: "(@(?:param|member|typedef|property|namespace|var|const|callback|iinput))(\\s*)({)",
                push: [
                    {
                        token: "lparen.doc",
                        regex: "{",
                ...
                regex: "(@(?:alias|memberof|instance|module|name|lends|namespace|external|this|template|"
                    + "requires|param|implements|function|extends|typedef|mixes|constructor|var|iinput"
